...
SpawConfig::setStaticConfigItem('SPAW_DIR', 'http://' .$_SERVER['SERVER_NAME'] . '/editor/');
...
// stylesheet
SpawConfig::setStaticConfigItem('default_stylesheet',SpawConfig::getStaticConfigValue('SPAW_DIR').'style.css');
// width 
...
SpawConfig::setStaticConfigItem(
  ...
  array(
    array(
      'dir'     => '/upload/',//SpawConfig::getStaticConfigValue('SPAW_DIR').'../images/',
      'caption' => 'Images',
      'params'  => array(
